...
ActiveRecord::Schema[8.0].define(version: 2025_10_18_065136) do
  ...
  create_table "procurement_invoices", force: :cascade do |t|
    ...
    t.index ["procurement_schedule_id", "created_at"], name: "index_procurement_invoices_schedule_created"
    t.index ["procurement_schedule_id"], name: "index_procurement_invoices_on_procurement_schedule_id"
    t.index ["status", "created_at"], name: "index_procurement_invoices_status_created"
  ...
  create_table "procurement_schedules", force: :cascade do |t|
    ...
    t.index ["status"], name: "index_procurement_schedules_on_status"
    t.index ["user_id", "from_date", "to_date", "status"], name: "index_procurement_schedules_user_dates_status"
    t.index ["user_id", "from_date", "to_date"], name: "index_procurement_schedules_on_user_and_dates"
    t.index ["user_id", "from_date", "to_date"], name: "index_procurement_schedules_on_user_dates"
    t.index ["user_id", "status", "created_at"], name: "index_procurement_schedules_user_status_created"
    t.index ["user_id"], name: "index_procurement_schedules_on_user_id"
    t.index ["vendor_name", "from_date"], name: "index_procurement_schedules_on_vendor_date"
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.boolean "is_active", default: true
    t.string "hsn_sac"
    t.index ["category_id", "name"], name: "index_products_category_name"
    ...
    t.index ["name"], name: "idx_products_name"
    t.index ["name"], name: "idx_products_name_gin", opclass: :gin_trgm_ops, using: :gin
    t.index ["name"], name: "index_products_on_name"
    t.index ["sku"], name: "index_products_on_sku", unique: true
    t.index ["unit_type"], name: "idx_products_unit_type"
  end
  ...
  add_foreign_key "customer_points", "customers"
  ...
  add_foreign_key "pending_payments", "customers", name: "pending_payments_customer_id_fkey"
  add_foreign_key "pending_payments", "users", name: "pending_payments_user_id_fkey"
