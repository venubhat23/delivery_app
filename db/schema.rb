...
ActiveRecord::Schema[8.0].define(version: 2025_11_20_113417) do
  ...
  create_table "payouts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "payout_type", default: "payment"
    t.string "payin_payout", default: "payout"
    t.index ["date", "paid_via"], name: "index_payouts_on_date_and_paid_via"
    t.index ["date"], name: "index_payouts_on_date"
    t.index ["paid_via"], name: "index_payouts_on_paid_via"
    t.index ["payin_payout"], name: "index_payouts_on_payin_payout"
    t.index ["payout_type"], name: "index_payouts_on_payout_type"
  end
